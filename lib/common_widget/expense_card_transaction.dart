...
class DayExpenseTransactions extends StatelessWidget {
  final Map sObj;
  final VoidCallback onPressed;

  const DayExpenseTransactions(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Container(
                padding:
                    const EdgeInsets.all(8), // Add some padding around the text
                decoration: BoxDecoration(
                  border: Border.all(
                      color: TColor.gray60, width: 1), // Define the border
                  borderRadius:
                      BorderRadius.circular(15), // Optional: Rounded corners
                ),
                child: Text(
                  sObj['date'].substring(8, 10),
                  style: TextStyle(
